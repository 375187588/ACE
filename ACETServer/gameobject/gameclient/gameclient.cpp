...
public:
	...
	//~Logging_Client() { logging_peer_.cancel(); }
	//ACE_Asynch_Write_Stream& peer() { return logging_peer_; }

private:
	ACE_SOCK_Stream logging_peer_;
	//ACE_Asynch_Write_Stream logging_peer_;
};
...
int Logging_Client::send(const Logging_Record &log_record)
{
	...
	const size_t maxSize = sizeof(log_record);// +ACE_CDR::MAX_ALIGNMENT;
